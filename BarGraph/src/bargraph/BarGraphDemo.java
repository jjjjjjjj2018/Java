...
/**
 * Application to demonstrate Model/View/Controller architecture with Observer
 * and Strategy design patterns. The application displays two views linked to an
 * underlying data model: a text-based view, and a bar-graph view. Changes to
 * either view change the model and cause the other view to update to
 * correspond.
 *
 * @author E. Stark
 * @version 20180407
...
public class BarGraphDemo extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        linearScaleItem.setOnAction(e -> {
            ScalingStrategy linearScale = new LinearScalingStrategy(SCALE);
        });

        MenuItem logScaleItem = new MenuItem("Logarithm");
        logScaleItem.setOnAction(e -> {
            ScalingStrategy logScale = new LogScalingStrategy(100, SCALE);
        });
        
        menu.getItems().addAll(linearScaleItem, logScaleItem);
